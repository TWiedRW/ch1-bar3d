...
datasets %>% 
  ...
  knitr::kable(caption = 'Values used in the experiment to make ratio comparisons, sorted by ratio. The ID label corresponds to the file reference number.', longtable = F, format = 'latex', booktabs = T) 
